#!/usr/bin/env python3
"""
Start HTTP server for viewing generic knowledge graph
"""
...
# Walks upward so this works both in-place and after copying to a project
# directory per the README's Manual Setup.
